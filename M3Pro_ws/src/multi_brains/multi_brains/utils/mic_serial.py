...
import time
class kws_mic:
    def __init__(self, port,event, baudrate=115200, timeout=1):
        ...
        while self.running:
            if self.ser and self.ser.is_open:
                try:
                   ...
                   print(f"receive fail: {e}. Make sure the wakeup_event object has the correct methods and is not being incorrectly used.")
            time.sleep(0.1)
